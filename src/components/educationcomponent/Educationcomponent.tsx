...
function moreInformationEducation(idFromClick:any, idCont:any, educationText:any) {
    ...
    <div className="educationContainer" id="Utbildning">
        ...
        <section className="educationText">
            ...
            <article key={education.heading} id={education.id}>
                <h2 className="educationTitle" onClick={()=>{
  
            moreInformationEducation(education.id, education.id1, education.text)
    
            }}>{education.heading} {education.text ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="#59f9b4">
